...
-- sequence user
CREATE SEQUENCE  SQ_LOGIN_USER NOCACHE;

-- type account, for example cash, saving, personal saving etc
CREATE TABLE BA_TYPE(
    BA_TYPE_ID NUMBER,
    NAME VARCHAR2(20),
...
-- sequence type
CREATE SEQUENCE SQ_BA_TYPE NOCACHE;

-- currencies available
CREATE TABLE BA_CURRENCY(
...
-- sequence currency
CREATE SEQUENCE SQ_BA_CURRENCY NOCACHE;
...
CREATE TABLE BA_ACCOUNT(
    ...
    FOREIGN KEY (LOGIN_USER_ID) REFERENCES LOGIN_USER(LOGIN_USER_ID),
    FOREIGN KEY (BA_TYPE_ID) REFERENCES BA_TYPE(BA_TYPE_ID),
    FOREIGN KEY (BA_CURRENCY_ID) REFERENCES BA_CURRENCY(BA_CURRENCY_ID)
);

-- sequence ba_account
CREATE SEQUENCE SQ_BA_ACCOUNT NOCACHE;
...
-- sequence category
CREATE SEQUENCE SQ_OP_CATEGORY NOCACHE;

-- transaction typ expense/income and more if is available
CREATE TABLE OP_TRANSACTION_TYPE(
...
CREATE SEQUENCE SQ_OP_TRANSACTION_TYPE NOCACHE;
...
CREATE TABLE OP_TRANSACTION(
    ...
    FOREIGN KEY (LOGIN_USER_ID) REFERENCES LOGIN_USER(LOGIN_USER_ID),
    FOREIGN KEY (BA_ACCOUNT_ID) REFERENCES BA_ACCOUNT(BA_ACCOUNT_ID),
    FOREIGN KEY (OP_TRANSACTION_TYPE_ID) REFERENCES OP_TRANSACTION_TYPE(OP_TRANSACTION_TYPE_ID),
    FOREIGN KEY (OP_CATEGORY_ID) REFERENCES  OP_CATEGORY(OP_CATEGORY_ID)
);

-- sequence transaction
CREATE SEQUENCE SQ_OP_TRANSACTION NOCACHE;
...
CREATE SEQUENCE SQ_OP_TRANSFER NOCACHE;
...
INSERT INTO BA_CURRENCY(BA_CURRENCY_ID, NAME, DESCRIPTION, CURRENCY_SYMBOL)
VALUES(SQ_BA_CURRENCY.nextval,'Quetzals','Currency for Guatemala City','Q');
INSERT INTO BA_CURRENCY(BA_CURRENCY_ID, NAME, DESCRIPTION, CURRENCY_SYMBOL)
VALUES(SQ_BA_CURRENCY.nextval,'Dollar','Currency for United States','$');

--Default Values for type bank account
INSERT INTO BA_TYPE(BA_TYPE_ID,NAME, DESCRIPTION)
VALUES(SQ_BA_TYPE.nextval,'Monetary','Monetary bank account, for your daily financial expenses');
INSERT INTO BA_TYPE(BA_TYPE_ID,NAME, DESCRIPTION)
VALUES(SQ_BA_TYPE.nextval,'Saving','Saving bank account, you do not need constant access to his money');

-- Default Values for category of transaction
INSERT INTO OP_CATEGORY(OP_CATEGORY_ID, NAME, DESCRIPTION)
VALUES(SQ_OP_CATEGORY.nextval,'Investments','Category for different investments');
INSERT INTO OP_CATEGORY(OP_CATEGORY_ID, NAME, DESCRIPTION)
VALUES (SQ_OP_CATEGORY.nextval,'Gym','Category for gym');
INSERT INTO OP_CATEGORY(OP_CATEGORY_ID, NAME, DESCRIPTION)
VALUES(SQ_OP_CATEGORY.nextval,'Shopping','Category for shopping');
INSERT INTO OP_CATEGORY(OP_CATEGORY_ID, NAME, DESCRIPTION)
VALUES(SQ_OP_CATEGORY.nextval,'Education','Category for Education and certificates');
INSERT INTO OP_CATEGORY(OP_CATEGORY_ID, NAME, DESCRIPTION)
VALUES(SQ_OP_CATEGORY.nextval,'Salary','Category for salary');
INSERT INTO OP_CATEGORY(OP_CATEGORY_ID, NAME, DESCRIPTION)
VALUES(SQ_OP_CATEGORY.nextval,'Others','Category for others')

-- Default Values for type of transaction
INSERT INTO OP_TRANSACTION_TYPE(OP_TRANSACTION_TYPE_ID, NAME, DESCRIPTION)
VALUES (SQ_OP_TRANSACTION_TYPE.nextval,'Income','Type for incomes');
INSERT INTO OP_TRANSACTION_TYPE(OP_TRANSACTION_TYPE_ID, NAME, DESCRIPTION)
VALUES (SQ_OP_TRANSACTION_TYPE.nextval,'Expense','Type for expenses');
